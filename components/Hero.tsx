...
export default function Hero() {
  return (
    <section className="relative min-h-[100dvh] flex items-center overflow-hidden bg-gradient-to-b from-navy-dark via-navy to-navy">
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 w-full pt-32 pb-20">
        <div className="max-w-xl">
          ...
          <ScrollReveal delay={0.2}>
            <div className="flex flex-wrap gap-4">
              <a
                href="#about"
                className="px-7 py-3 rounded-full border-2 border-white/30 text-sm font-semibold text-white hover:bg-white/10 hover:border-white/50 active:scale-[0.97] transition-all duration-300"
              >
                About Us
              </a>
              <a
